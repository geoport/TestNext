    ...
    return (
        <Accordion title="Proje Bilgileri" id="projectData">
            <div className="grid grid-cols-2 gap-2">
                ...
                <fields.InputField
                    onChange={handleInputChange}
                    value={data.projectData.contractor}
                    formField={form.contractor}
                />
                <fields.InputField
                    onChange={handleInputChange}
                    value={data.projectData.staticProjectOwner}
                    formField={form.staticProjectOwner}
                />
                <fields.InputField
                    onChange={handleInputChange}
                    value={data.projectData.architect}
                    formField={form.architect}
                />
                <fields.InputField
                    onChange={handleInputChange}
                    value={data.projectData.geologyEngineer}
                    formField={form.geologyEngineer}
                />
                <fields.InputField
                    onChange={handleInputChange}
                    value={data.projectData.geophysicEngineer}
